...
function render(){
  ...
  const pasos = res ? (()=>{
    const drug=state.drugName||"el medicamento"; const s=[];
    if(state.tipo==="liquido")
  ...
  app.innerHTML=`
    ...
    <div class="header">
      ...
      <div class="app-sub">Calcula cuanto administrar segun la prescripcion</div>
      ...
      <div class="input-block">
        ...
        <div class="irow" style="border-color:${bl}44">
          <input type="text" placeholder="Ej: Ceftriaxona, Paracetamol IV..."
            value="${state.drugName}" oninput="setState({drugName:this.value})"/>
        </div>
      </div>
      ...
      <div class="input-block" style="margin-bottom:0">
        ...
        <div class="irow" style="border-color:${bl}44">
          <input type="number" placeholder="Ej: 650" step="any" min="0"
            value="${state.dosis}" oninput="setState({dosis:this.value})"/>
          ...
          <div class="input-block" style="margin-bottom:0">
            ...
            <div class="irow" style="border-color:${bl}44">
              <input type="number" placeholder="Ej: 100" step="any" min="0"
                value="${state.volumen}" oninput="setState({volumen:this.value})"/>
        ...
        <div class="input-block">
          ...
          <div class="irow" style="border-color:${bl}44">
            <input type="number" placeholder="Ej: 1" step="any" min="0"
              value="${state.polvoContenido}" oninput="setState({polvoContenido:this.value})"/>
        ...
        <div class="input-block" style="margin-bottom:0">
          ...
          <div class="irow" style="border-color:${bl}44">
            <input type="number" placeholder="Ej: 10" step="any" min="0"
              value="${state.polvoDisolvente}" oninput="setState({polvoDisolvente:this.value})"/>
            <span class="iunit">mL</span>
          </div>
        </div>
        <div class="helper-text">
