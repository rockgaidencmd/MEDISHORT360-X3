...
function render(){
  ...
  if(drugInput){
    ...
    if(tipoContainer){
      ...
      if(tipoActual !== state.tipo){
        ...
        // Solo actualizar valores de inputs del tipo actual
  ...
  app.innerHTML=`
    ...
    <!-- RESULTADOS DINAMICOS (se actualizan sin cerrar teclado) -->
